...
describe('convertToPageConfig()', () => {
  it('separates _meta from components', () => {
    ...
    expect(page!.meta).toEqual({ title: 'Page 1', description: 'First page' })
    expect(page!.components).not.toHaveProperty('_meta')
    expect(page!.components).toHaveProperty('clock')
    expect(page!.components).toHaveProperty('button0')
  })
