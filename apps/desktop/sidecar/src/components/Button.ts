import { ICON_FONT_FAMILY, autoSizeText, canvasFont, ellipsisText } from '../utils/textUtils.ts'
...
export class Button {
  ...
  draw(ctx: CanvasRenderingContext2D, cellCoord: CellCoord): void {
    ...
    if (this.loadedImage) {
      ...
      autoSizeText(ctx, label1, maxWidth, 14, 10)
      ...
      autoSizeText(ctx, label3, maxWidth, 20, 12, 'bold')
